...
export default function SharedFilePage({ user }: { user: User }) {
  ...
  function fetchFolder() {
    return callAPI<FileItem[]>({
      url: `${API_URL}/shared-items?search=${search}&sortBy=${sortOption.sortBy}&sortDirection=${sortOption.sortDirection}`,
      method: "GET",
      authToken: getAccessToken() as string,
    });
  }
